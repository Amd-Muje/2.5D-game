...
public class BattleSystem : MonoBehaviour
{
    ...
    private const string ACTION_MASSAGE = "'s Action:";
    ...
    {
        actionText.text = playerBattlers[currentPlayer].Name + ACTION_MASSAGE;
    ...
    {
        allBattlers.Sort((bil1, bil2) => -bil1.Initiative.CompareTo(bil2.Initiative)); // sort initiative by ascending
    }
