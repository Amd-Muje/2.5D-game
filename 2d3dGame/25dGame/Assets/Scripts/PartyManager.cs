...
public class PartyManager : MonoBehaviour
{
    ...
    [SerializeField] private PartyMemberInfo defaultPartyMeber;
    ...
    private void Awake()
    {
        ...
        else
        {
            ...
            AddMemberToPartyByName(defaultPartyMeber.MemberName);
        }
    ...
    public void AddMemberToPartyByName(string memberName)
    {
        for (int i = 0; i < allMembers.Length; i++)
        {
            if (allMembers[i].MemberName == memberName)
            {
                ...
                newPartyMember.Initiative = allMembers[i].BaseInitative;
